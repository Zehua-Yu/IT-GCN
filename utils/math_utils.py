...
def evaluation(y, y_, x_stats):
    ...
    if dim == 3:
        ...
        #用于输出预测结果和对应的ground truth到指定文件
        # with open('gt_cad93lll.csv', "a") as csv_file:
        #     writer = csv.writer(csv_file)
        #     writer.writerows(v)
        #     csv_file.close()
        # # # with open('v_and_v_1.csv', "a") as csv_file:
        # # #     writer = csv.writer(csv_file)
        # # #     writer.writerows(v - v_)
        # # #     csv_file.close()
        # with open('pre_cad93lll.csv', "a") as csv_file:
        #     writer = csv.writer(csv_file)
        #     writer.writerows(v_)
        #     csv_file.close()
