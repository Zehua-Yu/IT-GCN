...
diff = 3
days = 146
input_original_data = 'time_series_covid19_confirmed_US_0809.csv'
output_confirmed_collection_ntran = f'Covid19_V_US_confirmed_collection_0809_{diff}diff_51_ntran.csv'
output_confirmed_collection = f'Covid19_V_US_confirmed_collection_0809_{diff}diff_51.csv'
